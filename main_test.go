...
func Test_kubernetestFakeFailure(t *testing.T) {
	...
	// is already tested
	found1 := found[0]
	if found1 != fn1.Name && found1 != fn2.Name {
		t.Fatalf("expected: %q or %q, got %q", fn1.Name, fn2.Name, found1)
	}

	found2 := found[1]
	if found2 != fn1.Name && found2 != fn2.Name {
		t.Fatalf("expected: %q or %q, got %q", fn1.Name, fn2.Name, found2)
	}
